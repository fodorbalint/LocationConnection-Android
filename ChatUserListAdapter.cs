...
namespace LocationConnection
{
	class ChatUserListAdapter : BaseAdapter<string>
	{
		...
		public override View GetView(int position, View convertView, ViewGroup parent)
		{
			...
			{
				ItemMainLayout.SetBackgroundResource(Resource.Drawable.background_selector_active);
			}
			else
			{
				ItemMainLayout.SetBackgroundResource(Resource.Drawable.background_selector_passive);
            }
